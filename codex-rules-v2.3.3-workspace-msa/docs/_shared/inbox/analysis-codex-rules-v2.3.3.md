...
- 로컬서치 도구: `.codex/tools/local-search/` (MCP + HTTP 폴백)
...
- 설정: `.codex/config.toml`, `.codex/tools/local-search/config/config.json`
...
## 6. local-search 문서/코드 정합성 2차 리뷰
...
- 도구 문서: `codex-rules-v2.3.3-workspace-msa/.codex/tools/local-search/README.md`
