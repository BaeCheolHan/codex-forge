...
- **버전 정합성 통일**: 코드(v2.4.3)와 문서(v2.3.3/v2.4.2)간의 불일치 해소
- **모든 산출물 동기화**: `docs/`, `install.sh`, `.codex/` 등 14개 포인트의 버전을 `v2.4.3`으로 단일화
- **Multi-CLI 지원 공식화**: Gemini CLI와 Codex CLI 모두에 대해 `v2.4.3` 룰셋 적용
